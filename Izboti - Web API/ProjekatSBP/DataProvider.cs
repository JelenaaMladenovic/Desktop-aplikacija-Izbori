...
namespace ProjekatSBP
{
    public class DataProvider
    {
        ...
        /* public static IntervjuNovineView vratiIntervju(int id)
         {
             IntervjuNovineView pb = new IntervjuNovineView();
             try
             {
                 ISession s = DataLayer.GetSession();

                 ProjekatSBP.Entiteti.IntervjuNovine o = s.Load<ProjekatSBP.Entiteti.IntervjuNovine>(id);
                 pb = new IntervjuNovineView(o);
        ...
        /* public static TVIRadioEmisijeView VratiEmisiju(int id)
         {
             TVIRadioEmisijeView pb = new TVIRadioEmisijeView();
             try
             {
                 ISession s = DataLayer.GetSession();

                 ProjekatSBP.Entiteti.TVIRadioEmisije o = s.Load<ProjekatSBP.Entiteti.TVIRadioEmisije>(id);
                 pb = new TVIRadioEmisijeView(o);
        ...
        public static List<SpisakPitanjaView> VratiPitanjaDuela(int duelId)
        {
        ...
        public static List<ProtivkandidatiView> VratiProtivkandidateDuela(int duelId)
        {
        ...
        public static ReklamaView AzurirajReklamu(ReklamaView r)
        {
            try
            {
                ISession s = DataLayer.GetSession();
        ...
        public static List<AkcijaView> VratiSveAkcije()
        {
            ...
            try
            {
                ...
                {
                    akcije.Add(new AkcijaView(a.id, a.naziv, a.grad, a.lokacija, a.f_deljenje_letaka, a.f_susret_sa_gradjanima, a.vreme, a.f_miting, a.f_na_otvorenom, a.f_na_zatvorenom, a.naziv_firme, a.cena_prostora, a.koordinator));
                }
                s.Close();
            }
            catch (Exception ex)
        ...
        public static AkcijaView AzurirajAkciju(AkcijaView a)
        {
            try
            {
                ISession s = DataLayer.GetSession();
        ...
        public static AkcijaView vratiAkciju(int id)
        {
            ...
            try
            {
                ...
                ab = new AkcijaView(o.id, o.naziv, o.grad, o.lokacija, o.f_deljenje_letaka, o.f_susret_sa_gradjanima, o.vreme, o.f_miting, o.f_na_otvorenom, o.f_na_zatvorenom, o.naziv_firme, o.cena_prostora, o.koordinator);
       ...
       /* public static Koordinator VratiKoordinatora(int id)
        ...
        public static List<Akcija> MitingGosti(int idGosta)  //vraca mitinge odredjenog gosta i onda treba da ih doda kod gosta u listu mitinga
            //ali ne ynam da li radi???
        {
        ...
        public static GostView AzurirajGosta(GostView g)
        {
            try
            {
                ISession s = DataLayer.GetSession();
        ...
        public static List<Gost> GostiNaMitingu(int idMitinga)  //ovo je bila metoda GostiMitinga u drugom delu, ali je preimenovana
        {
